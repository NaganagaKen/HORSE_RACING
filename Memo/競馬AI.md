...
### 7/7やること
- [ ] TrueSkill, Glicko2, Elo Ratingをfeatures.pyから分離して、計算済の辞書を予測で使えるようにする。
  - [済] TrueSkill
  - [ ] Glicko2
  - [ ] Elo Rating
- [ ] 他の特徴量選択方法も試す(selectKBestなど、実行速度的に学習が必要ないモデルを使いたい)
...
- 2020-2025年のデータと、2008-2025年までのデータでは、loglossのスコアがかなり違うがこれはなぜか。
  - 2020-2025年 ... 0.6399
  - 2008-2025年 ... 0.6712
- optunaの目的関数では、レース内で正規化する前のloglossを最小化するようしているが、本当に合っているのか？
